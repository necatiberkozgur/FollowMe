...
public class AddClientPanel extends JPanel {
	...
	private ListTable<IUser> tableClients;
	...
	public AddClientPanel() {
		...
		gbc_panelClient.insets = new Insets(0, 0, 0, 5);
		gbc_panelClient.fill = GridBagConstraints.BOTH;
		gbc_panelClient.gridx = 0;
		gbc_panelClient.gridy = 1;
		panel.add(panelClient, gbc_panelClient);
		GridBagLayout gbl_panelClient = new GridBagLayout();
		gbl_panelClient.columnWidths = new int[] { 0 };
		gbl_panelClient.rowHeights = new int[] { 0, 40 };
		gbl_panelClient.columnWeights = new double[] { 1.0 };
		gbl_panelClient.rowWeights = new double[] { 1.0, 0.0 };
		panelClient.setLayout(gbl_panelClient);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBorder(BorderFactory.createTitledBorder("Current Clients"));
		...
		GridBagConstraints gbc_panelClientButtons = new GridBagConstraints();
		gbc_panelClientButtons.fill = GridBagConstraints.BOTH;
		gbc_panelClientButtons.gridx = 0;
		gbc_panelClientButtons.gridy = 1;
		panelClient.add(panelClientButtons, gbc_panelClientButtons);
		GridBagLayout gbl_panelClientButtons = new GridBagLayout();
		gbl_panelClientButtons.columnWidths = new int[] { 0, 0, 0 };
		gbl_panelClientButtons.rowHeights = new int[] { 0 };
		gbl_panelClientButtons.columnWeights = new double[] { 0.0, 0.0, 0.0 };
		gbl_panelClientButtons.rowWeights = new double[] { 0.0 };
		panelClientButtons.setLayout(gbl_panelClientButtons);
		...
		gbc_btnBack.gridx = 0;
		gbc_btnBack.gridy = 0;
		panelClientButtons.add(buttonBack, gbc_btnBack);
		...
		panelClientButtons.add(lblPageNum, gbc_lblPageNum);
		...
		gbc_btnNext.gridx = 2;
		gbc_btnNext.gridy = 0;
		panelClientButtons.add(buttonNext, gbc_btnNext);
		...
		scrollPaneSelection.setBorder(BorderFactory.createTitledBorder("Selected Clients"));
		...
		tableClients = new ListTable<IUser>(IUser.class, Messages::getString);
		scrollPane.setViewportView(getTableClients());
	...
	public ListTable<IUser> getTableClients() {
	...
	public AbstractButton getBtnAdminLogout() {
